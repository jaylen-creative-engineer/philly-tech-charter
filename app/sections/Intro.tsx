    ...
    <section className="max-w-[1200px] mx-auto px-12 py-[120px] max-md:px-6 max-md:py-20">
      <div className="grid grid-cols-2 gap-16 items-start max-md:grid-cols-1 max-md:gap-10">
        <ScrollReveal className="sticky top-20 max-md:static">
          ...
          <div className="mt-8 max-md:mt-6">
            <ImagePlaceholder
              variant="tech"
              aspect="landscape"
              label="Philadelphia · Tech & Culture"
        ...
        <ScrollReveal delay={100} className="pt-4">
          <p className="text-[19px] font-semibold leading-[1.65] text-[var(--color-blue)] mb-8 flex items-start gap-3">
            <span className="icon-badge mt-0.5 h-10 w-10 text-[var(--color-red)] shrink-0">
              <CharterIcon name="culture" size={20} />
            </span>
            <span>

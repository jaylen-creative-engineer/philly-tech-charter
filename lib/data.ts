...
export const PRINCIPLES: Principle[] = [
  {
    ...
    body: "We commit to naming what we are building toward before we build it. Intention is valuable work. It turns ambition into clear direction. The principles we hold and the levers we build into our systems are how we make sure innovation creates the impact we actually want.",
  },
  {
    num: "02",
